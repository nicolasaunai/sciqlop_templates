...
p.plots[1].plot("speasy/cda/THEMIS/THA/L2/THA_L2_ESA/tha_peim_t3_mag")

# Champ magnétique GSM
p.plot("speasy/cda/THEMIS/THA/L2/THA_L2_FGM/tha_fgh_gsm")
p.plots[2].plot("speasy/cda/THEMIS/THA/L2/THA_L2_FGM/tha_fgs_gsm")
...
p.plots[1].yAxis.setRange(10, 2000)
p.plots[2].yAxis.setRange(-75, 75)
p.plots[3].yAxis.setRange(0.01, 150)
